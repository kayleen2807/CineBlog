<aside class="sidebar">
    <div style="display:flex;flex-direction:column;gap:15px;">
        <h2>Admin Panel</h2>
        <div style="height:1px;background:var(--muted);margin:10px 0;"></div>
        <!-- Menú lateral para el admin, con enlaces a las diferentes secciones del panel de administración -->
